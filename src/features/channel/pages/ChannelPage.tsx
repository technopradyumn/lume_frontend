...
import { useParams } from "../../../shared/components/Navigation";
import {
...
export function ChannelPage() {
  ...
  const [channel, setChannel] = useState<UserSummary | null>(null);
      ...
      current
        ? {
            ...
            subscribersCount: Math.max(
              0,
              (current.subscribersCount || 0) + (current.isSubscribed ? -1 : 1),
            ),
          }
        : null,
    );
  ...
  const handleAddReply = (tweetId: string, updatedTweet: TweetItem) => {
